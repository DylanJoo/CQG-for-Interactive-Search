...
def cross_attention_forward(
        ...
        """
        This codes is copied from huggingface's T5LayerCrossAttention
        source code: https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_t5.py
