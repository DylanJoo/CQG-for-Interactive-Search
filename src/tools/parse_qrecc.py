...
def main(args):
    canard = json.load(open(args.path_qrecc, 'r'))
    ...
    for topic in quac:
        ...
        for turn in topic['paragraphs'][0]['qas']:
            ...
            if turn_id.split("q#")[1] != str(i):
                print(f"[FIX] Incorrent turn numbers found and is fixed now.")
...
if __name__ == '__main__':
    ...
    parser.add_argument("-qrecc", "--path_qrecc", default="data/canard/train.json", type=str)
